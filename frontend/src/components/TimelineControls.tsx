    ...
    >
      <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl border border-gray-200 p-4 min-w-[500px]">
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          <div className="ml-4 flex items-center gap-2">
            ...
            <select
              ...
              className="text-xs font-mono bg-gray-50 border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-cyan-400 cursor-pointer"
            >
        ...
        <p className="text-xs text-center text-gray-500 mt-3">
          {isPlaying
            ? `Watching at ${playbackSpeed}x speed...`
